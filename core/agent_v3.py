# agent_v3.py — D3QN fixes for loss collapse + epsilon decay
# Changes from previous version:
#   1. Faster epsilon decay to reach 0.05 by ~episode 700
#   2. PER alpha reduced — less aggressive priority, more diversity in sampling
#   3. Higher learning rate schedule — unfreezes learning after early convergence
#   4. Larger batch size — smoother gradients, less chance of loss collapse
#   5. Target net update frequency reduced — keeps targets fresh longer
#   6. Added noise injection to prevent deterministic policy collapse
